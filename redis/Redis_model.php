...
class Redis_model
{
     ...
     * 
     * @param string $key 缓存key
     * @param string  $field 字段,多个字段用逗号分割
     * @return int
     */
